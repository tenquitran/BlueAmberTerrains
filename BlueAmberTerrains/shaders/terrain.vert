...
layout(location = 1) in float vColor;     // slope or height-based color
...
smooth out vec4 outColor;    // slope or height-based color converted to RGBA
...
void main()
{
	...
	outColor = vec4(vColor, vColor, vColor, 1.0);
